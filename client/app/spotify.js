  ...
  return(
    <div>
      <div className="well well-lg">
        <h1>About Mega Moonlings</h1>
        <p>Mega Moonlings is a cookie-clicker inspired application that is an exercise in storing and retrieving data from a Mongo database using Mongoose as well as using React and Bootstrap to create a pleasant user experience. The story of the game is that you found a button on the moon that when clicked gives you 1 Dollar Coin<sup>TM</sup>. So you must hire Moonlings to click the button for you. Thankfully for you there are nearly infintie Moonlings, and they are all eager to work for you for a small sum of 100 Dollar Coins<sup>TM</sup>.</p>
        <address>
